...
#define UNITS_PER_MM TO_FIXED_UNSIGNED(201.20724)
#define UNITS_PER_MM_Z TO_FIXED_UNSIGNED(201.20724 * Z_STEP_FACTOR)
#define UNITS_PER_INCH TO_FIXED_UNSIGNED(5110.66389)
#define UNITS_PER_INCH_Z TO_FIXED_UNSIGNED(5110.66389 * Z_STEP_FACTOR)
