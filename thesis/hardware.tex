...
Sprung across the second pair, again mounted on linear bearings, is the head
assembly. It houses the interchangeable head, which holds the drawing
...
\begin{figure}[ht]
    \begin{center}
        \includegraphics[width=0.75\linewidth]{pcb}
...
\begin{figure}[ht]
    \begin{center}
        \includegraphics[width=0.75\linewidth]{pcb_photo}
